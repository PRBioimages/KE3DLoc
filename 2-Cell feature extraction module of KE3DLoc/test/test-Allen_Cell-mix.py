...
class ProteinDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return torch.tensor(image), torch.tensor(label2)
...
def main():
    ...
    save_path = '/little_normalize_new/loss_w_single'
    ...
    val_dataset = ProteinDataset(csv_file='../../data_list/Allen_Cell_test_data.csv', root='../Data')
