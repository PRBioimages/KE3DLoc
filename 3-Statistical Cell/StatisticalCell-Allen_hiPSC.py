...
def main():
    ...
    train_dataset = ProteinDataset(csv_file='../data_list/Allen_hiPSC_train_data.csv', root='../Data')
    train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=12, shuffle=True, num_workers=2,
                                               generator=g)

    val_dataset = ProteinDataset(csv_file='../data_list/Allen_hiPSC_val_data.csv', root='../Data')
