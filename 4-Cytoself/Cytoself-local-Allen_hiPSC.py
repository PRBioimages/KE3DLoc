...
def main():
    ...
    train_dataset = ProteinDataset(csv_file='allen_big_train_data_id.csv', root='../Data',
                                   embedding_file="embedding_feature/Allen_Cell_hiPSC_train_vqvec1.npy")
    train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=12, shuffle=True, num_workers=2,
                                                   generator=g)

    val_dataset = ProteinDataset(csv_file='allen_big_val_data_id.csv', root='../Data',
                                 embedding_file="embedding_feature/Allen_Cell_hiPSC_val_vqvec1.npy")
