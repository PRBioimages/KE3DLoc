...
def main():
    ...
    val_dataset = ProteinDataset(csv_file='allen_little_test_data_id.csv', root='../Data',
                                 embedding_file="../embedding_feature/Allen_Cell_test_vqvec1.npy")
